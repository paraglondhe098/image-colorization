...
```
The code for the project is contained in the [`notebook.ipynb`](notebook_old.ipynb) Jupyter notebook file. You can run the notebook in a Jupyter notebook environment or on cloud platforms like Google Colab.
